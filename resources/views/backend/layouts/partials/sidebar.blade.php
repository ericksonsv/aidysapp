<aside id="sidebar">
	...
	<div class="sidebar-dropdown-menu">
		<a href="" class="sidebar-link{{ setActive('backend.roles.*') }}">
			<div>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		...
		<a href="" class="sidebar-link{{ setActive('backend.permissions.*') }}">
			<div>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		...
		<a href="" class="sidebar-link{{ setActive('backend.users.*') }}">
			<div>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
