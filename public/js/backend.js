...
window.Toast = Toast; // SweetAlert
// Vue


window.Vue = vue__WEBPACK_IMPORTED_MODULE_1___default.a; // Vue
// Axios


window.axios = axios__WEBPACK_IMPORTED_MODULE_2___default.a;
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // Axios
// Toggle Sidebar
...
var _loop = function _loop(i) {
  sidebarDropDowns[i].addEventListener('click', function (e) {
    e.preventDefault();
    e.stopPropagation();
    sidebarDropDowns[i].classList.toggle('is-open');
    var currentDropdown = sidebarDropDowns[i].nextElementSibling;
...
for (var i = sidebarDropDowns.length - 1; i >= 0; i--) {
  _loop(i);
} // Sidebar Dropdowns
// Toggle User Menu


var toggleAuthMenuBtn = document.querySelector('#toggle-auth-menu-btn');
var authMenu = document.querySelector('#auth-menu');
toggleAuthMenuBtn.addEventListener('click', function (e) {
  e.preventDefault();
  e.stopPropagation();
...
__webpack_require__(/*! C:\laragon\www\aidysapp\resources\js\backend.js */"./resources/js/backend.js");
module.exports = __webpack_require__(/*! C:\laragon\www\aidysapp\resources\sass\backend.scss */"./resources/sass/backend.scss");
